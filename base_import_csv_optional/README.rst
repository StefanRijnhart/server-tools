...
`here <https://github.com/OCA/server-tools/issues/new?body=module:%base_import_csv_optional%0Aversion:%2010.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
